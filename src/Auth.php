...
class Auth
{
   ...
   public function authenticate(\Zend_Auth_Adapter_Interface $adapter)
   {
      ...
      if(get_class($identity) !== 'SocialOAuth\Auth\Identity\Generic' &&
         !is_subclass_of($identity, 'SocialOAuth\Auth\Identity\Generic')) {
      ...
      if(false === $currentIdentity 
          || get_class($currentIdentity) !== 'SocialOAuth\Auth\Identity\Container') 
      {
